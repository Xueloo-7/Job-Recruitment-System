        ...
        vm.Application.SalaryExpecteds = new List<SelectListItem>
{
    ...
    public IActionResult Apply(ApplyPageVM vm, string includeResume)
    {
        ...
        if (!string.IsNullOrEmpty(includeResume) && includeResume == "true" && profileResume == null)
        {
            ...
            {
                SetFlashMessage(FlashMessageType.Info, "Please upload your resume in your profile first.");
        ...
        SetFlashMessage(FlashMessageType.Success, "Application submitted successfully!");
    ...
    public IActionResult DeleteApplication(string? id)
    {
        ...
        if (app != null)
        {
            ...
            db.SaveChanges();
            SetFlashMessage(FlashMessageType.Success, "Application canceled successfully.");
        }
